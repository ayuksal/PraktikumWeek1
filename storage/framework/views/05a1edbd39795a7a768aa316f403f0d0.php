                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <button class="dropdown-item active bg-purple" type="button">
                                            <small><i class="bi-brightness-high-fill me-2"></i>Light</small>s
                                        </button>
                                    </li>
                                    <li>
                                        <button class="dropdown-item" type="button">
    ...
    <div id="bs-icons">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="<?php echo e(Vite::asset('resources/images/bs.png')); ?>"
                        alt="Bootstrap Icons" />
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\ASUS\PraktikumWeek1\resources\views/index.blade.php ENDPATH**/ ?>